// inspired by https://github.com/kevinongko/vue-numeric

import Vue from 'vue/dist/vue'

import template from './dec_input.html!text'

import accounting from 'npm:accounting-js@1.1.1'

export default Vue.component('DecInput', {
  template,
  props: {
    /**
     * Currency symbol.
